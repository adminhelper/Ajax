...
public class SampleDAO {
	private static String namelist = 
			"김수현,송중기,송혜교,김지원,조진웅,박해진," +
			"진구,설현,하니,소진,혜리,원더걸스,베이비복스," +
			"소녀시대,레드벨벳,원더우먼,슈퍼맨,배트맨," +
			"헐크,이소룡,성룡,이연걸";
	...
	static {
		...
		for(int i=0;i<names.length;i++) {
			...
			Contact c = new Contact(nextNo, names[i],
									tel, "서울시");
			contacts.add(0, c);
		}
	}
	...
	public static ContactList getContacts() {
		ContactList cList = new ContactList(0, 0, 
	...
	public static ContactList getContacts(
		...
		ContactList cList = new ContactList(
				pageno, pagesize, contacts.size(), temps);
		return cList;
	}
